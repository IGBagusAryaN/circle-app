            ...
            <Box display="flex" alignItems="start" gap="3">
              ...
              <Box display="flex" flexDirection="column">
                <Box display="flex" gap="2">
                  ...
                  <Text color="gray.400">
                    @frankycolala<span> • 17d</span>
                  </Text>
                </Box>
                <Link to="/">
                  <Text fontSize="14px" marginTop="2" textAlign={'left'}>
                    Wow, this looks stunning! The details and composition are
                    just perfect. 👏✨
                  </Text>
                </Link>
                <Box>
              ...
              <Box display="flex" alignItems="start" gap="3">
                ...
                <Box display="flex" flexDirection="column">
                  <Box display="flex" gap="2">
                    ...
                    <Text color="gray.400">
                      @portgasdace<span> • 17d</span>
                    </Text>
                  </Box>
                  <Box>
                    <Text fontSize="14px" marginTop="2" textAlign="left">
                      Why do I look like I'm about to solve a big problem, when
                      we were probably just fighting over Luffy's leftovers? 😂
                    </Text>
                  </Box>
                  <Box>
                    <Box
